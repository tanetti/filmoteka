...
export const onTrailerClick = async target => {
  ...
  const markup = `<iframe class="trailer-modal__farame is-hidden" type="text/html" width="560" height="315" src="https://www.youtube.com/embed/${key}?autplay=1&showinfo=0&origin=https://tanetti.github.io&hl=${
